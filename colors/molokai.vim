...
"The word 'endi' followed by any amount of white space from the beginning of
"the line plus the end of line, or 1 or more whitespace is an error.  This
"happens periodically during paste.  pinhole fix
call matchadd("EricsCustomVimMatcherHighlights", '\zs\(^\s*endi$\|^\s*endi\s\+\)')
