...
set background=dark
let g:colors_name="molokaigitignore"
...
"Special instructions for .gitignore files

highlight EricsCustomGitIgnoreHighlights ctermbg=24 guibg=red
...
call matchadd('EricsCustomGitIgnoreHighlights', '\zs\(\S\zs\s\{2,}$\)')

"call matchadd('EricsCustomGitIgnoreHighlights', '\zs\(\S\zs\s\{2,}$\)')
"


"Highlight certain kinds, just a taste
syn match  Keyword "\%(\*.swp\)"
syn match  Keyword "\%(\*.py\[cod\]\)"
