...
" marks column
   ...
   "hi Tag ctermfg=161
   hi Title ctermfg=164 cterm=bold        "This one changes the h1 and h2 color

   "hi htmlH1 ctermfg=201 cterm=bold        "This one changes the h1 color
   "hi htmlH2 ctermfg=164 cterm=bold        "This one changes the h2 color
   "hi htmlH3 ctermfg=160 cterm=bold        "This one changes the h2 color
   hi htmlH1 ctermfg=201 ctermbg=015 cterm=bold        "This one changes the h1 color
   "hi htmlH2 ctermfg=236 ctermbg=251 cterm=bold        "This one changes the h2 color
   hi htmlH2 ctermfg=161 ctermbg=014 cterm=bold        "This one changes the h2 color
   "hi htmlH3 ctermfg=81 ctermbg=013 cterm=bold        "This one changes the h3 color
   hi htmlH3 ctermfg=82 cterm=bold        "This one changes the h3 color
   hi htmlH4 ctermfg=201 cterm=bold                    "This one changes the h4 color

   hi htmlBold ctermfg=009 ctermbg=232 cterm=bold      "This one changes bold
