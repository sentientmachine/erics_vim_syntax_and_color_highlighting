...
"ERICS NOTICE
"you need to disable the sh.vim files under  here for this file to take
" 58: /usr/share/vim/vim80/ftplugin/sh.vim
 "59: ~/.vim/syntax/sh.vim
 "60: /usr/share/vim/vim80/syntax/sh.vim
 "61: /usr/share/vim/vim80/indent/sh.vim
...
"Don't highlight the print statement!  That's not right!
...
if exists("b:is_bash")
 ...
 syn match   shCharClass	'\[:\%(alnum\|alpha\|ascii\|blank\|cntrl\|digit\|graph\|print\|lower\|punct\|space\|upper\|word\|or\|xdigit\):\]'			contained
else
