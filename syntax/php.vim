...
" Control Structures
syn keyword phpStatement if else elseif while do for foreach switch case default return goto as endif endwhile endfor endforeach endswitch declare endeclare contained
...
syn keyword phpContBreak continue break
...
" Exception Keywords
syn keyword phpStatementTryCatch try catch throw contained
...
" Clusters
syn cluster phpClConst contains=phpFunctions,phpClasses,phpIdentifier,phpStatement,phpStatementTryCatch,phpOperator,phpStringSingle,phpStringDouble,phpBacktick,phpNumber,phpType,phpBoolean,phpStructure,phpMethodsVar,phpConstants,phpException,phpSuperglobals,phpMagicConstants,phpServerVars
syn cluster phpClInside contains=@phpClConst,phpComment,phpParent,phpParentError,phpInclude,phpHereDoc,phpNowDoc
syn cluster phpClFunction contains=@phpClInside,phpDefine,phpParentError,phpStorageClass,phpSpecial,phpContBreak
