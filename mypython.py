...
unnecessary_whitespace_after              
float something = 5    #python isn't a typed language

def foobar():
    return = 7    #derp

foobar.trim()     #python has no string trim

thing = strip(foobar)  #no method named strip
